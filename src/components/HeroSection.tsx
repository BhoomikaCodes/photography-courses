...
function HeroSection() {
  return (
    <div className="h-auto md:h-[49rem] w-full 
    ...
    justify-center relative overflow-hidden mx-auto py-10 md:py-0">
        ...
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <h1 className="mt-20 md:mt-0 text-4xl md:text-7xl md:leading-normal
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 
                max-w-lg mx-auto">
                Dive into our comprehensive photography courses and transform your photographic journey today. Whether you're a beginner or looking to refine your skills, join us to unlock your true potential.
            </p>
